...
# UYARI!!!
# BU SCRİPT KAPALI KAYNAK DAĞITILIR VE KODLAR GİZLENMİŞTİR. SADECE ÜCRETLENDİRİLMİŞ PLANLARI SATIN ALAN VE BELİRLENMİŞ KİŞİLER BU KODA ERİŞİM SAĞLAYABİLİR. EĞER AUDO SCANNER'IN KODLARINA FARKLI YOLLARLA ERİŞTİYSENİZ, LÜTFEN BİZE DISCORD ÜZERİNDEN İLETİŞİME GEÇİN!
# Discord Sunucumuz: [https://discord.gg/g4KBRZ5Ghz]
